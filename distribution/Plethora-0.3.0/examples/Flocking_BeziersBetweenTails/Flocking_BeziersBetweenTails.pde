...
void draw() {
  ...
  for (Ple_Agent pa : boids) {
    ...
    //draw Lines between the tails of the agents
    strokeWeight(1);
    stroke(0,90);
    //specify the population and the ranges for the lines 
     pa.drawBeziersBetweenTails(boids, 20,60, 40,40);
